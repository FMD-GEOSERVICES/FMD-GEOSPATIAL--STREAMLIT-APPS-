...
@st.cache_data
def get_data():
    csv_file_path = f"C:\\Users\\FMD GEO-SERVICES\\Streamlit_Apps\\World_Population_Data.csv"
...
with col2:
        ...
        # I can use st.write for a subheader i the same manner with markdown using ###
...
# Initialize Folium map centered on the selected country
